...
import 'carousel_admin_screen.dart';
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<CarouselProvider>().loadAllCarousel();
    });
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: const TabBar(
            tabs: [
              Tab(icon: Icon(Icons.music_note), text: 'Contenido'),
              Tab(icon: Icon(Icons.category), text: 'Categorías'),
              Tab(icon: Icon(Icons.view_carousel), text: 'Carrusel'),
            ],
          ),
          actions: [
            IconButton(
        ...
        floatingActionButton: const _DynamicFAB(),
      ),
    );
  }
}
...
class _ContentTab extends StatelessWidget {
  ...
  Future<void> _deleteContent(BuildContext context, String id) async {
                  ...
                  trailing: PopupMenuButton(
                    ...
                    onSelected: (value) {
                      if (value == 'edit') {
                        ...
                        _deleteContent(context, content.id);
                      }
                    },
                  ),
                ),
